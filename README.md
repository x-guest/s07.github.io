...
```mermaid
graph TD;
    Меню-->Общие-->Основное-->Настройки;
    Общие-->Свет-->Настройки;
    Общие-->Кузов-->Настройки;
    Общие-->Двери-->Настройки;
    Меню-->Вождение-->Настройки;
    Меню-->Энергия-->Настройки;
    Меню-->Звук-->Настройки;
    Меню-->Дисплей-->Экран-->Настройки;
    Дисплей-->AR-HUD-->Настройки;
    Меню-->Голос-->Ассистент-->Настройки;
    Голос-->Общение-->Настройки;
    Меню-->Сети-->Настройки;
    Меню-->Сервис-->Настройки;
    Меню-->Deepal-->Настройки;
```
